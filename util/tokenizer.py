...
class EngKorTokenizer:
    def __init__(self, max_len=512):
        self.eng_tokenizer = BertTokenizer.from_pretrained("bert-base-multilingual-cased")
        self.kor_tokenizer = BertTokenizer.from_pretrained("bert-base-multilingual-cased")
